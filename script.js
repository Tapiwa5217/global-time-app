...
window.onload = () => {
         ...
         fetch('https://cors-anywhere.herokuapp.com/https://worldtimeapi.org/api/timezone')
...
let newTimeZoneData = () => {
    ...
    fetch('https://cors-anywhere.herokuapp.com/https://worldtimeapi.org/api/timezone/'+ timeZoneSelector.value + '')
    .then((res) => { return res.json(); })
    .then((data) => {
